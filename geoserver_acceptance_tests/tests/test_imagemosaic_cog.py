"""
ImageMosaic acceptance tests for GeoServer using COG granules.

These tests require GeoServer to be configured with a PostGIS datastore accessible via JNDI (jdbc/postgis).
