...
class GeoServerCloudSync:
    ...
    def __init__(
        ...
        self.src_instance: RestService = RestService(src_url, self.src_auth, src_verifytls)
        ...
        self.dst_instance: RestService = RestService(dst_url, self.dst_auth, src_verifytls)
